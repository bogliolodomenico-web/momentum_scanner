...
hide_streamlit_style = """
    <style>
        ...
        /* MODIFICATO: Non usiamo display:none sull'header altrimenti distruggiamo il tasto di riapertura */
        header[data-testid="stHeader"] {
            background: transparent !important;
            pointer-events: none;
        }
        /* Rendiamo invisibile e spostiamo fuori dallo schermo il pulsante nativo di riapertura */
        ...
        /* ========== NUOVO PULSANTE OPEN SIDEBAR (ALTO A DESTRA) ========== */
        ...
        .custom-open-btn:hover {
            background: #eadeb8 !important;
            transform: translateY(-1px) !important;
        }
        /* Nasconde automaticamente il pulsante quando la barra laterale è già aperta */
        body:has(section[data-testid="stSidebar"][data-collapsed="false"]) .custom-open-container,
        body:has(section[data-testid="stSidebar"]:not([data-collapsed="true"])) .custom-open-container {
    ...
    <div class="custom-open-container">
        <button class="custom-open-btn" onclick="
            var btn = window.parent.document.querySelector('header[data-testid=\'stHeader\'] [data-testid=\'stSidebarCollapseButton\']') || document.querySelector('header[data-testid=\'stHeader\'] [data-testid=\'stSidebarCollapseButton\']');
            if (btn) { btn.click(); }
